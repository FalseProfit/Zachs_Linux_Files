...
# Usage function
usage() {
    echo "Usage: $0 hostname.domain.com [-O <remote_outbound_via_local_socks_port>] [-I <local_into_remote_network_via_local_socks_port>] [-N <nessus_port>] [-R <remote_into_local_port>]"
    exit 1
}
